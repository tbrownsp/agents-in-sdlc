...
- **Professional formatting**: Notes are structured with section headings for each part of the 5-part formula
...
1. Select **Load unpacked** (top left corner)
...
3. Select the NewsedIt extension icon in your toolbar
4. Fill in the 5-part CRM note fields
5. Select **Auto-Fill & Post Note** to post your note
...
- Notes are structured using the 5-part CRM formula, with each section labeled by a heading
- Draft notes are saved locally in your browser. When you post a note, its contents are sent to Dash CRM.
