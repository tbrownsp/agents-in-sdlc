...
**It is NOT the deployment workflow for this repo's site.** This repo's workshop site is built by [`.github/workflows/pages.yml`](../../workflows/pages.yml) on every PR/push and, when the repository has GitHub Pages enabled and `ENABLE_GITHUB_PAGES_DEPLOY=true`, publishes the Astro + Starlight build under `website/dist/` to GitHub Pages.
